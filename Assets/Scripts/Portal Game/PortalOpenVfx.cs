...
{
    // Names generated by PortalSurfaceVisual. The open-pulse should not scale these rings;
    // they already animate through their material.
    ...
    [Header("Pulse")]
    [Tooltip("Total duration for the screen pulse, expanding ring, and burst particles.")]
    public float duration = 0.28f;

    [Tooltip("Scale amount applied to non-energy portal visuals during the opening pulse.")]
    public float framePulseScale = 0.08f;

    [Header("Opening Ring")]
    [Tooltip("Starting line width of the temporary expanding ring.")]
    public float ringWidth = 0.055f;

    [Tooltip("Horizontal radius of the temporary expanding ring.")]
    public float ringXRadius = 0.55f;

    [Tooltip("Vertical radius of the temporary expanding ring.")]
    public float ringYRadius = 1.08f;

    [Header("Opening Light")]
    [Tooltip("Range of the short-lived point light spawned by the open burst.")]
    public float lightRange = 3f;

    [Tooltip("Peak intensity of the short-lived point light spawned by the open burst.")]
